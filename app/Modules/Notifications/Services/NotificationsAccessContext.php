...
class NotificationsAccessContext
{
    ...
    public function organizations(): Collection
    {
        return Organization::query()
            ->whereIn('id', $this->memberships()->pluck('organization_id')->unique())
            ->orderBy('name')
            ->get();
    }
    ...
    {
        $filters = collect($input)->only(['organization_id', 'farm_id', 'status', 'severity', 'source_module', 'date_from', 'date_to', 'due_soon'])
