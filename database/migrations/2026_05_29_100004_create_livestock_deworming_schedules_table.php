...
return new class extends Migration
{
    ...
    {
        Schema::create('livestock_deworming_schedules', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('dewormer_name');
            $table->string('dewormer_type')->nullable();
    ...
    {
        Schema::dropIfExists('livestock_deworming_schedules');
    }
};