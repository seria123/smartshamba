        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Record New Harvest</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('harvests.store') }}" method="POST">
                             ...
                             <div class="col-md-4">
                                 <div class="mb-3">
                                     ...
                                     <input type="date" class="form-control @error('harvest_date') is-invalid @enderror" 
                                         id="harvest_date" name="harvest_date" value="{{ old('harvest_date', now()->toDateString()) }}" required>
                                     @error('harvest_date')
                                     <div class="invalid-feedback">{{ $message }}</div>
                                     @enderror
                                 </div>
                             ...
                             <div class="col-md-4">
                                 <div class="mb-3">
                                     ...
                                     <input type="text" class="form-control @error('harvest_batch') is-invalid @enderror" 
                                         id="harvest_batch" name="harvest_batch" value="{{ old('harvest_batch') }}" placeholder="e.g., BATCH-2024-001">
                                     @error('harvest_batch')
                                     <div class="invalid-feedback">{{ $message }}</div>
                                     @enderror
                                 </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('quantity_harvested') is-invalid @enderror" 
                                        id="quantity_harvested" name="quantity_harvested" value="{{ old('quantity_harvested', 0) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('quality_grade') is-invalid @enderror" id="quality_grade" name="quality_grade" required>
                                        <option value="grade_a" {{ old('quality_grade') == 'grade_a' ? 'selected' : '' }}>Grade A (Premium)</option>
                                        <option value="grade_b" {{ old('quality_grade', 'grade_b') == 'grade_b' ? 'selected' : '' }}>Grade B (Standard)</option>
                                        <option value="grade_c" {{ old('quality_grade') == 'grade_c' ? 'selected' : '' }}>Grade C (Economy)</option>
                                        <option value="reject" {{ old('quality_grade') == 'reject' ? 'selected' : '' }}>Reject</option>
                                    </select>
                                    @error('quality_grade')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('quality_percentage') is-invalid @enderror" 
                                        id="quality_percentage" name="quality_percentage" value="{{ old('quality_percentage', 100) }}">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('moisture_content') is-invalid @enderror" 
                                        id="moisture_content" name="moisture_content" value="{{ old('moisture_content') }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('loss_quantity') is-invalid @enderror" 
                                        id="loss_quantity" name="loss_quantity" value="{{ old('loss_quantity', 0) }}">
                                    @error('loss_quantity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('loss_reason') is-invalid @enderror" 
                                        id="loss_reason" name="loss_reason" value="{{ old('loss_reason') }}" placeholder="e.g., pest damage, weather">
                                    @error('loss_reason')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('storage_location') is-invalid @enderror" id="storage_location" name="storage_location" required>
                                        <option value="warehouse" {{ old('storage_location', 'warehouse') == 'warehouse' ? 'selected' : '' }}>Warehouse</option>
                                        <option value="barn" {{ old('storage_location') == 'barn' ? 'selected' : '' }}>Barn</option>
                                        <option value="cold_storage" {{ old('storage_location') == 'cold_storage' ? 'selected' : '' }}>Cold Storage</option>
                                        <option value="field" {{ old('storage_location') == 'field' ? 'selected' : '' }}>In Field</option>
                                        <option value="sold_immediately" {{ old('storage_location') == 'sold_immediately' ? 'selected' : '' }}>Sold Immediately</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('storage_details') is-invalid @enderror" 
                                        id="storage_details" name="storage_details" value="{{ old('storage_details') }}" placeholder="e.g., Warehouse A, Shelf 3">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i> Save Harvest Record
                            </button>
                        </div>
                    </form>
                </div>
