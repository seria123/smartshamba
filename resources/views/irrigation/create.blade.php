    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><i class="fas fa-tint"></i> Create Irrigation Zone</h1>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('controller_id') is-invalid @enderror" 
                                           id="controller_id" name="controller_id" value="{{ old('controller_id') }}">
                                    @error('controller_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('valve_id') is-invalid @enderror" 
                                           id="valve_id" name="valve_id" value="{{ old('valve_id') }}">
                                    @error('valve_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('flow_rate_lph') is-invalid @enderror" 
                                           id="flow_rate_lph" name="flow_rate_lph" step="0.01" min="0" value="{{ old('flow_rate_lph') }}">
                                    @error('flow_rate_lph')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror" 
                                           id="duration_minutes" name="duration_minutes" min="1" value="{{ old('duration_minutes') }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('soil_moisture_threshold') is-invalid @enderror" 
                                           id="soil_moisture_threshold" name="soil_moisture_threshold" step="0.1" min="0" max="100" value="{{ old('soil_moisture_threshold') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('schedule_type') is-invalid @enderror" 
                                        ...
                                        @foreach($scheduleTypes as $key => $label)
                                            <option value="{{ $key }}" {{ old('schedule_type', 'manual') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('schedule_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
