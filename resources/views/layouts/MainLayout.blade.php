                    ...
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="hidden md:flex items-center space-x-1">
                            ...
                            <a href="{{ route('dashboard') }}"
                               class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-emerald-600 text-white shadow-md shadow-emerald-200' : 'text-green-100 hover:bg-green-600 hover:text-white' }}">
                                <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                            </a>

                            <a href="{{ route('farms.index') }}"
                               class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('farms.*') ? 'bg-emerald-600 text-white shadow-md shadow-emerald-200' : 'text-green-100 hover:bg-green-600 hover:text-white' }}">
                                <i class="fas fa-warehouse mr-2"></i>Farms
                            </a>

                            <div class="relative group">
                                <button class="flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 text-green-100 hover:bg-green-600 hover:text-white">
                            ...
                            <!-- Analytics -->
                            <div class="relative group">
                                <button class="flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('reports.*') || request()->routeIs('yield_estimations.*') ? 'bg-emerald-600 text-white shadow-md shadow-emerald-200' : 'text-green-100 hover:bg-green-600 hover:text-white' }}">
                            ...
                            <!-- Finance -->
                            <div class="relative group">
                                <button class="flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('revenues.*') || request()->routeIs('expenses.*') ? 'bg-emerald-600 text-white shadow-md shadow-emerald-200' : 'text-green-100 hover:bg-green-600 hover:text-white' }}">
                            ...
                            <a href="{{ route('staff.index') }}"
                               class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('staff.*') ? 'bg-emerald-600 text-white shadow-md shadow-emerald-200' : 'text-green-100 hover:bg-green-600 hover:text-white' }}">
