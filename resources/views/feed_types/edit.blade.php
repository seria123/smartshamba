...
<div class="p-4 max-w-2xl">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('feed_types.update', $feedType) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('feed_types.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                    Cancel
                </a>
