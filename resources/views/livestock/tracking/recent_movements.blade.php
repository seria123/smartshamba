...
@section('title', 'All Movements - SmartShamba')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Recent Movements</h1>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">
                            <a href="{{ route('livestock.show', $movement->livestock) }}" class="font-medium hover:text-primary">
                                {{ $movement->livestock->name ?? 'Unknown' }}
                            </a>
                            <br><small class="text-gray-500">{{ $movement->livestock->tag_number ?? 'No tag' }}</small>
                        </td>
