...
@section('title', 'Create Planting Schedule - SmartShamba')
        ...
        <x-ui.card>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <input type="date" name="planting_date" id="planting_date" value="{{ old('planting_date') }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <select name="season" id="season" required
                        ...
                        <option value="year_round" {{ old('season') == 'year_round' ? 'selected' : '' }}>Year Round</option>
                    </select>
                    @error('season')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="status" id="status" required
                        ...
                        <option value="planted" {{ old('status') == 'planted' ? 'selected' : '' }}>Planted</option>
                        <option value="growing" {{ old('status') == 'growing' ? 'selected' : '' }}>Growing</option>
                        <option value="ready_for_harvest" {{ old('status') == 'ready_for_harvest' ? 'selected' : '' }}>Ready for Harvest</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                ...
                <div>
                    ...
                    <input type="number" name="completion_percentage" id="completion_percentage" 
                        value="{{ old('completion_percentage', '0') }}" min="0" max="100" required
                ...
                <div>
                    ...
                    <input type="number" name="estimated_quantity" id="estimated_quantity" value="{{ old('estimated_quantity') }}" 
                        step="0.01" min="0"
                ...
                <div>
                    ...
                    <input type="text" name="quantity_unit" id="quantity_unit" value="{{ old('quantity_unit') }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <input type="text" name="current_stage" id="current_stage" value="{{ old('current_stage') }}"
            ...
            <div class="mt-6">
                ...
                <textarea name="notes" id="notes" rows="4"
                    ...
                    placeholder="Additional notes about this planting schedule...">{{ old('notes') }}</textarea>
                @error('notes')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
